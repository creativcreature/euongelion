...
| Cross-page navigation             | Sticky nav is stable, consistent, and non-janky              |       4 |   6 | Add scroll-state integration tests + snapshot baselines           | [Linear](https://linear.app/) stable shell behavior                              |
...
| Homepage UX       | Masthead sizing/fidelity                      |       4 |   6 | Add viewport/font-load snapshot assertions for clipping                                            | Newspaper masthead standards                                                 |
...
| Navigation        | Sticky desktop nav                            |       4 |   6 | Add deterministic dock state tests and fallback state                                              | [Notion](https://www.notion.so/) sticky shell                                |
| Navigation        | Sticky mobile nav                             |       4 |   6 | Ensure single source of truth for dock thresholds                                                  | [Linear mobile web](https://linear.app/) minimal sticky controls             |
| Navigation        | Menu correctness                              |       4 |   6 | Remove duplicate routes and add route-health test                                                  | Common SaaS nav QA pattern                                                   |
...
| Typography        | Readability floor                             |       4 |   6 | Enforce min readable size at 375/390 breakpoints                                                   | WCAG + Apple readability guidance                                            |
...
| Devotional UX     | Onboarding Wed/Thu/Fri variants               |       4 |   6 | Expand day-start branching tests and copy variants                                                 | [Headspace onboarding adaptation](https://www.headspace.com/)                |
| Chat              | Local-corpus-only guardrail                   |       5 |   5 | Add explicit refusal + source-scope UI indicators                                                  | Safe assistant scoping                                                       |
| Chat              | Citation visibility                           |       4 |   6 | Link response segments to source metadata inline                                                   | [Perplexity](https://www.perplexity.ai/) citation expectation                |
...
| Billing           | Entitlement checks                            |       3 |   7 | Implement full entitlement middleware with test coverage                                           | [Headspace subscriptions](https://www.headspace.com/)                        |
| Billing           | Payment lifecycle states                      |       4 |   6 | Continue end-to-end tests after adding checkout flash + portal management + restore messaging path | [RevenueCat](https://www.revenuecat.com/) flow patterns                      |
| iOS               | Shell readiness                               |       4 |   6 | Keep capacitor shell parity and deep-link behavior tests                                           | Apple HIG shell patterns                                                     |
| iOS               | App Store submission readiness                |       4 |   6 | Complete policy metadata/evidence checklist                                                        | [Apple App Review](https://developer.apple.com/app-store/review/guidelines/) |
