# F-006: Homepage UX: Hero proportion parity
...
- Status: in-progress
- Slug: homepage-ux-hero-proportion-parity
...
- Feature behavior and UX quality for: Hero proportion parity
- Tracking and regression prevention for this feature

### Out of scope

- Unrelated feature changes not mapped to F-006
...
| ---------- | ------- | ------------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------ | -------------------- | ----------- | ----------------------------------------------------------------------- |
| 2026-02-14 | pending | SA-013       | F-006      | Rebalanced mobile hero image crop with taller slot, softer zoom, and top-biased focal point adjustment to reduce clipping artifacts. | `type-check`, `lint` | 4 -> 4.6    | Screenshot-based parity validation and manual mobile QA still required. |
