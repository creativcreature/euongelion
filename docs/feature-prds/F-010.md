...
| 2026-02-14 | pending | SA-013                 | F-010      | Added global scroll-unlock lifecycle guards and removed sticky/nav overflow collapse patterns that could trap scrolling on mobile/inner routes. Also normalized touch-action on horizontal mobile strips.  | `lint`, `type-check`, `test`, `verify:*`                             | 7.4 -> 7.8           | Validate on physical iOS Safari + Android touch. |
