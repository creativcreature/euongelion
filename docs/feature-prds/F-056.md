...
- M00 (canonical IA / navigation UX) — Soul Audit generation pipeline fix (retro-registered 2026-07-10)

## Device Contracts

### Desktop

- Generation pipeline repairs; shipped May 2026. Behavior identical across breakpoints (server-side pipeline work; no bespoke desktop surface).
