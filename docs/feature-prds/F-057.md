...
- M00 (canonical IA / navigation UX) — RAG pipeline / reference index deploy (retro-registered 2026-07-10)

## Device Contracts

### Desktop

- Real reference-library index deployed to Workers; shipped May 2026. Behavior identical across breakpoints (server-side pipeline work; no bespoke desktop surface).
