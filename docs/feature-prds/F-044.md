...
| 2026-06-13 | pending | SA-013         | F-044      | Finish-line Wave 1 accessibility: ARIA disclosure semantics on audit cards, named landmarks/regions (footer nav, results `aria-labelledby`, crisis), `aria-live` on async/toast/empty/error, accessible names on icon/repeat buttons, `aria-current` on day rail. Covers F-044/045/046. | type-check, lint 0, 1402 tests                | 4 -> 6      | Manual VoiceOver/TalkBack pass on key flows; contrast snapshot gates.        |
