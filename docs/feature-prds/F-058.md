...
- M00 (canonical IA / navigation UX) — Async day generation (retro-registered 2026-07-10)

## Device Contracts

### Desktop

- Select timeout fixed via async job + polling; shipped May 2026. Behavior identical across breakpoints (server-side pipeline work; no bespoke desktop surface).
