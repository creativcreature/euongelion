...
This document contains email templates for partnership outreach across five key categories:

1. Churches
2. Ministries/Parachurch Organizations
3. Christian Influencers
4. Podcast Hosts
5. Authors

Each category includes an initial outreach email, follow-up template, and partnership proposal framework.

**Voice:** Warm, professional, never salesy. Peer-to-peer, not vendor-to-customer. We're offering value, not asking for favors.
...
1. **Research first.** Know who you're writing to. Mention something specific about their work.

2. **Lead with value.** What do we offer them? Not what do we want from them.

3. **Be brief.** Busy people don't read long emails. Get to the point.

4. **Make it easy.** Clear ask. Easy next step. No friction.

5. **Follow up once.** If no response after 7 days, one gentle follow-up. Then move on.

**Universal Replacements:**

- [RECIPIENT NAME] — Their first name
...
**Subject:** A resource for your congregation

---

Hi [PASTOR/LEADER NAME],
...
- Free daily devotional content (no accounts required)
- Deep theological teaching (Hebrew/Greek word studies, historical context)
- Content that respects intelligence without requiring seminary training
- A gentle on-ramp for people who aren't ready for church but are spiritually hungry
...
**Subject:** Re: A resource for your congregation
...
1. **Congregation Access**
   - Share wokegod.world with your congregation as a supplemental devotional resource
   - Recommend specific series aligned with your current teaching series
   - Provide content for small group discussion starters

2. **Custom Integration (Optional)**
   - We can create a landing page branded for [CHURCH NAME]
   - Track engagement from your congregation (aggregated, anonymous)
   - Provide monthly reports on content that resonates

3. **Pastoral Resources**
   - Early access to new content for teaching preparation
   - Deep-dive theological notes behind each series
   - "Shepherd" pathway content designed specifically for ministry leaders
...
1. I'll send you early access to the platform
2. You explore the content and identify what might serve your congregation
3. We reconnect in [X weeks] to discuss implementation
...
Hi [MINISTRY LEADER NAME],

I've followed [MINISTRY NAME]'s work for a while now—especially [SPECIFIC WORK REFERENCE]. What you're doing matters.
...
**Would you be open to a brief call to explore whether there's a fit?**
...
2. **Custom Content (Potential)**
   - If there are topics specific to your audience we don't currently cover, we can prioritize creating them
   - Co-created series with [MINISTRY NAME] attribution

3. **Amplification**
   - We'll promote [MINISTRY NAME] to our audience where appropriate
   - Cross-sharing that benefits both communities
...
1. I'll send you early platform access
2. You explore and identify relevant content for your community
3. We finalize partnership details in [X weeks]
...
I've been following your content for a while—especially [SPECIFIC WORK REFERENCE]. The way you [specific thing they do well] really resonates.
...
- Deep content (Hebrew/Greek word studies, real stories, honest questions)
- No accounts required
- No slick Christian marketing—just content worth your time
- Designed for the spiritually hungry who might not fit in traditional church
...
Either way, keep doing what you're doing. It matters.
...
3. **Affiliate/Ambassador Program (Optional)**
   - Track conversions from your audience
   - Potential revenue share or donation in your name to charity of choice

4. **Co-Creation (Optional)**
   - If there's a series you'd like to create together, we're open to it
   - Your voice, our platform, shared audience

**What We Ask:**

1. Explore the content honestly
2. Share with your audience if (and only if) it genuinely resonates
3. Provide feedback on what works for your community
...
**Subject:** Guest pitch — or just a resource for your audience

---

Hi [HOST NAME],

I've been listening to [PODCAST NAME]—especially the episode on [SPECIFIC EPISODE]. The conversation about [specific topic] stuck with me.
...
- Deep content (Hebrew/Greek word studies, historical context, real stories)
- No accounts required
- Designed for the spiritually curious who don't fit neatly into church categories
- Free. No manipulation. No guilt trips.
...
**Subject:** Re: Guest pitch — or just a resource for your audience
...
Looking forward to our conversation on [DATE]. Here's some background to help with prep:
...
1. Why build a faith platform when church attendance is declining?
2. How do you create content for both believers and skeptics?
3. What's the PaRDeS framework and why does it matter?
4. Privacy-first design in a data-hungry industry
5. The tension between depth and accessibility
...
I recently read [BOOK TITLE], and [specific thing that resonated]. It's stayed with me.
...
- Deep content (Hebrew/Greek word studies, historical context, stories that connect)
- No accounts required
- Designed for the spiritually hungry who aren't being reached by traditional channels
- Free. Honest. No manipulation.
...
- If you'd like early access, I'd love to get your feedback
...
Thanks for your interest. Here's what collaboration might look like:

**What We Offer:**

1. **Content Alignment**
   - We can create series that complement your book's themes
   - Cross-reference your work as a recommended resource in relevant devotionals
   - Provide a custom landing page for readers coming from your audience

2. **Amplification**
   - We'll promote your work to our audience where naturally relevant
   - Include book mentions in content where it serves readers

3. **Co-Creation (Optional)**
   - If you're interested, we could develop a series together
   - Your theological insights, our platform and format
...
This is a mutual value exchange, not a paid partnership.

**Next Steps:**

1. I'll send you full platform access
2. You explore and note where your work aligns
3. We reconnect to discuss specifics
...
| 7   | Follow-up email (if no response)                              |
| 14  | Final soft touch via different channel (LinkedIn, Twitter DM) |
| 21+ | Move to "Later" list—revisit in 3-6 months                    |
...
Move on gracefully. Some partnerships aren't meant to be. Focus energy on those who engage.

---

## Tracking Partnerships

| Partner | Category | Status            | Last Contact | Next Step            |
| ------- | -------- | ----------------- | ------------ | -------------------- |
| [Name]  | Church   | Interested        | [Date]       | Send platform access |
| [Name]  | Podcast  | No response       | [Date]       | Follow-up email      |
| [Name]  | Author   | Meeting scheduled | [Date]       | Prep materials       |

---

_These templates serve the mission: Shepherd God's flock to Jesus. Every partnership should extend our reach to people who need to find their way home._
