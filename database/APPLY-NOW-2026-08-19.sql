-- ═══════════════════════════════════════════════════════════════════════
--  EUANGELION — RUN THIS IN THE SUPABASE SQL EDITOR (one paste, like last night)
--  Prepared 2026-08-19. SA-091 / F-137 — reading-progress sync.
--
--  WHAT: makes user_progress keyable by devotional SLUG (the key the app
--  actually has). Until applied, cross-device reading progress stays off and
--  the API reports CONFIG_FEATURE_DISABLED naming this migration.
--
--  SAFETY: additive + constraint-relaxing only. No drops of tables/columns.
--  Running twice is harmless. EXPECTED RESULT: "Success. No rows returned."
-- ═══════════════════════════════════════════════════════════════════════
