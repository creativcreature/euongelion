...
export const PASTORAL_MESSAGES = {
  ...
  DAILY_SUBMIT_LIMIT:
    'You’ve reached today’s limit for soul audits. Come back tomorrow for a fresh start.',
  DAILY_PLAN_LIMIT:
    'You’ve reached today’s limit for new devotional plans. Come back tomorrow to begin another.',
  GENERATION_PAUSED:
  ...
  INVALID_REROLL_ID:
    'Something went wrong with your reroll. Please start a new audit.',
  CLARIFIER_PROMPT:
