...
export const SERIES_DATA: Record<string, SeriesInfo> = {
  ...
  'the-harvest': {
    ...
    question: 'What if the person you wrote off is wheat?',
    introduction:
    ...
    context:
      'You cannot tell wheat from darnel until the heads form — and you cannot tell who is truly faithful by looking, either. A week for everyone tempted to sort people too soon, and everyone wondering what their place in a mixed world is. Jesus’ answer is not the sickle. It is the seed.',
