...
export const SERIES_DATA: Record<string, SeriesInfo> = {
  ...
  'the-harvest': {
    ...
    introduction:
      "An enemy sowed weeds through the wheat by night, and the servants asked the obvious question: should we pull them up? The Master said no — because a life’s harvest is never called early. Seven days inside Jesus' parable of the mixed field: God's enduring patience with those who have not yet turned, and the witness He plants beside them.",
    context:
