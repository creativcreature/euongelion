          ...
          <div className="md:col-span-10 md:col-start-2">
            <div className="space-y-1 md:space-y-2">
              {series.days.map((day, index) => {
                ...
                return (
                  <div key={day.slug} className={`observe-fade ${index > 0 ? `fade-in-delay-${Math.min(index, 4)}` : ''}`}>
                    {isLocked ? (
                      <div
                      ...
                      >
                        <div className={`grid md:grid-cols-12 gap-6 md:gap-12 py-8 md:py-10 border-b border-gray-200 ${day.day === 3 ? 'md:bg-gray-50 md:-mx-8 md:px-8' : ''}`}>
                          ...
                          <div className="md:col-span-9">
                            <p className="text-serif-italic vw-body-lg text-gray-300">
                              {day.title}
                            </p>
                          </div>
