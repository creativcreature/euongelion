 ...
 * /today — YOUR reading.
 *
 * Founder 2026-08-16: "Daily Bread should be the Today page, and Today page
 * should be the Daily Bread page. The Daily Edition, is now The Daily Bread."
 *
 * So the two swapped (SA-059). This route carries what used to live at
 * /daily-bread: your active plan, your place in it, your next reading. The
 * newspaper moved the other way and is now The Daily Bread at /daily-bread.
 *
 * SA-033's substance survives the rename — one of these two pages means YOUR
 * devotional and the other means the shared edition; only the names traded
...
import HoldingState from '@/components/today/HoldingState'
import CompletionState from '@/components/today/CompletionState'
import CuratedActiveView from '@/components/today/CuratedActiveView'
import ScheduledSwapBanner from '@/components/today/ScheduledSwapBanner'
