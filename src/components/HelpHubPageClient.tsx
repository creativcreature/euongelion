...
export default function HelpHubPageClient() {
  ...
  return (
    <div className="newspaper-home min-h-screen">
      ...
      <main id="main-content" className="shell-content-pad mx-auto max-w-5xl">
        <Breadcrumbs
          className="mb-7"
        ...
        <header className="mb-10 border-b border-[var(--color-border)] pb-7">
          ...
          <p className="vw-body text-secondary">
            Search help topics, review the homepage FAQ answers, and replay the
            devotional walkthrough anytime.
          </p>
        </header>
