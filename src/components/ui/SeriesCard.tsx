...
export function SeriesCard({ series }: Props) {
  return (
    <Link href={`/series/${series.slug}`} className="block group">
      <article className="p-5 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded-lg transition-all hover:border-zinc-300 dark:hover:border-zinc-600 hover:shadow-sm">
        ...
        <div className="flex items-center gap-4 text-sm text-zinc-500 dark:text-zinc-500">
          ...
          {series.gospel_presentation && (
            <span className="flex items-center gap-1">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
                <path d="M10 1a.75.75 0 0 1 .75.75v1.5a.75.75 0 0 1-1.5 0v-1.5A.75.75 0 0 1 10 1ZM5.05 3.05a.75.75 0 0 1 1.06 0l1.062 1.06A.75.75 0 1 1 6.11 5.173L5.05 4.11a.75.75 0 0 1 0-1.06ZM14.95 3.05a.75.75 0 0 1 0 1.06l-1.062 1.062a.75.75 0 0 1-1.061-1.061l1.062-1.061a.75.75 0 0 1 1.06 0ZM3 8a.75.75 0 0 1 .75-.75h1.5a.75.75 0 0 1 0 1.5h-1.5A.75.75 0 0 1 3 8ZM14 8a.75.75 0 0 1 .75-.75h1.5a.75.75 0 0 1 0 1.5h-1.5A.75.75 0 0 1 14 8ZM7.172 13.89a.75.75 0 0 1-1.061-1.061l1.061-1.061a.75.75 0 1 1 1.061 1.06l-1.06 1.062ZM12.828 10.768a.75.75 0 0 1 0 1.061l-1.06 1.061a.75.75 0 1 1-1.062-1.06l1.061-1.062a.75.75 0 0 1 1.06 0ZM10 13.5a.75.75 0 0 1 .75.75v1.5a.75.75 0 0 1-1.5 0v-1.5a.75.75 0 0 1 .75-.75Z" />
              </svg>
              Gospel: {series.gospel_presentation}
            </span>
          )}
        </div>

        {series.core_theme && (
          <p className="mt-3 pt-3 border-t border-zinc-100 dark:border-zinc-800 text-xs text-zinc-500 dark:text-zinc-500 line-clamp-2">
            {series.core_theme}
          </p>
        )}
      </article>
