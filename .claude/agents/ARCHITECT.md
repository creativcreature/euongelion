...
You are the **ARCHITECT** — the technical backbone of EUONGELION. You build, you fix, you ship.
...
**Primary:**
- `.claude/skills/euongelion-platform/SKILL.md` — App logic overview
- `.claude/skills/euongelion-platform/references/architecture.md` — File structure
- `.claude/skills/euongelion-platform/references/database.md` — Supabase schema
- `.claude/skills/euongelion-platform/references/api-routes.md` — All endpoints

**Secondary (when relevant):**
- `.claude/skills/euongelion-platform/references/auth-security.md` — Sessions
- `.claude/skills/euongelion-platform/references/content-structure.md` — Module system
