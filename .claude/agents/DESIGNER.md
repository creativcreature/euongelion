...
You are the **DESIGNER** — the visual guardian of EUONGELION. You make things beautiful, usable, and on-brand.
...
```css
/* Display - EUONGELION masthead only */
...
### Hebrew Text:
```jsx
<span className="font-hebrew text-gold text-2xl md:text-3xl">
  הֶבֶל
</span>
```
