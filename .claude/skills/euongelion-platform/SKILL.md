...
This skill defines how to build the EUONGELION devotional platform - all logic, routes, database, and user flows. For visual styling, use the `wokegod-brand` skill.
