...
**Purpose:** Complete type specifications for EUONGELION platform
...
**Usage:** "EUONGELION" wordmark only
...
```css
/* Desktop */
.day-number { font-size: 120px; }

/* Tablet */
@media (max-width: 1439px) {
  .day-number { font-size: 90px; }
}

/* Mobile */
@media (max-width: 767px) {
  .day-number { font-size: 70px; }
}
```
